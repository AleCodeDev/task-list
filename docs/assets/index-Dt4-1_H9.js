...
</footer>`;let m;const O=e=>{if(m||(m=document.querySelector(e)),!m)throw new Error(`Element ${e} not found`);m.innerText=l.getTodos(d.Pending).length},k=e=>{if(!e)throw new Error("Se esperaba un TODO");const{done:t,description:i,id:a}=e,o=`
        <div class="view">
